...
public class TokenConfig {
	...
	//新增临时素材的URL
	private static String tempMaterialUrl="https://api.weixin.qq.com/cgi-bin/media/upload?access_token=ACCESS_TOKEN&type=TYPE";
	
	//获取临时带参数二维码的URL
	private static String createTicketUrl="https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=TOKEN";
	
	//下载二维码的URL
	private static String gainTicketUrl="https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=TICKET ";
	...
	//获取新增临时素材接口
	public static String getTempMaterialUrl() {
		String newTempMaterialUrl=tempMaterialUrl.replace("ACCESS_TOKEN",TokenConfig.getAccessToken()).replace("TYPE", "image");
		return newTempMaterialUrl;
	}
	
	//获取获取二维码的接口
	public static String getCreateTicketUrl() {
		String newCreateTicketUrl=createTicketUrl.replace("TOKEN",TokenConfig.getAccessToken());
		return newCreateTicketUrl;
	}
	
	//下载二维码图片的借口
	public static String getGainTicketUrl(String ticket) {
		String newGainTicketUrl=gainTicketUrl.replace("TICKET", ticket);
		return newGainTicketUrl;
	}
}
